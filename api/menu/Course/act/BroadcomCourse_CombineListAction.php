...
class BroadcomCourse_CombineListAction extends ActionBase
{
    ...
    public function doMainValidate(Controller $controller, User $user, Request $request)
    {
        ...
        if ($request->hasParameter("multi")) {
            ...
            $audition_type = null;
            $item_id = null;
            if ($request->getParameter("course_type") == BroadcomCourseEntity::COURSE_TYPE_AUDITION_SQUAD) {
            ...
            $request->setAttribute("course_type", $request->getParameter("course_type"));
            ...
            $request->setAttribute("student_id", $request->hasParameter("student_id"));
            $request->setAttribute("teacher_member_id", $request->hasParameter("teacher_member_id"));
        }
    ...
    {
Utility::testVariable($repond_course_list);
