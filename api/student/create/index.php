 ...
 * 系统主目录
 */
define("SRC_PATH", str_replace("\\", "/", dirname(dirname(dirname(dirname(__FILE__))))));
...
$request->current_menu = "student";
$request->current_act = "create";
$launcher->api($controller, $user, $request);
?>