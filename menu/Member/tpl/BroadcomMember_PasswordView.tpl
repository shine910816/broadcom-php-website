...
{^/if^}
  ...
  <div class="table-line">
    <a href="./?menu=member&act=top" class="button-field ui-btn-b ui-btn-grey"><i class="fa fa-chevron-left"></i> 返回</a>
    <button type="submit" name="do_change" value="1" class="button-field ui-btn-b"><i class="fa fa-check"></i> 确认修改</button>
  </div>
</form>
