...
{
    const SUBJECT_ENGLISH = "1";
    const SUBJECT_CHINESE = "2";
    const SUBJECT_MATHS = "3";
    const SUBJECT_PHYSICS = "4";
    const SUBJECT_CHEMISTRY = "5";
    const SUBJECT_HISTORY = "6";
    const SUBJECT_POLITICS = "7";
    const SUBJECT_GEOGRAPHY = "8";
