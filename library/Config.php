...
class Config
{
    ...
    public static function getAllowedCurrent()
    {
        ...
        $result["education"]["schedule_list"] = SYSTEM_AUTH_ADMIN;
        $result["education"]["schedule_create"] = SYSTEM_AUTH_ADMIN;
        $result["education"]["schedule_info"] = SYSTEM_AUTH_ADMIN;
    ...
    public static function getNavigation()
    {
        ...
        $result["education"]["schedule_list"] = array('<a href="./?menu=education&act=top">学员教务</a>', "班课课程管理");
